...
{
public:
	BT_NodeConditional( std::string name, BT_BlackboardMap& blackboard );
	BT_NodeConditional( std::string name, BT_BlackboardMap& blackboard, std::function<BT_RESULT( bool )> callback );
	~BT_NodeConditional();
...
private:
	...
	static inline int m_factoryIndex = registerFactoryMethod<BT_NodeConditional>("BT_NodeConditional");
};
